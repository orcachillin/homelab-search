...
export async function get(props: SearchProps) {
	...
	const syntax = parseSearchSyntax(
		props.query ?? "",
		readyProviders.map((provider) => provider.name),
	);
		...
		<section class="search-shell">
			...
			<div class="search-main">
				<SearchForm
					...
					selectedMedia={
						syntax.mediaTypes.length > 0 ? syntax.mediaTypes.map(String) : values(props.mediaTypes)
					}
